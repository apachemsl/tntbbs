...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.tnt.core.entity.MarkConfig m_markConfig;
	...
	public com.tnt.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.tnt.core.entity.MarkConfig m_markConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tnt.core.entity.CmsConfig)) return false;
		else {
			com.tnt.core.entity.CmsConfig cmsConfig = (com.tnt.core.entity.CmsConfig) obj;
