package com.tnt.core.entity.base;
...
public abstract class BaseCmsSite implements Serializable {
	 ...
	 */
	public BaseCmsSite(java.lang.Integer id,
			com.tnt.core.entity.CmsConfig config, java.lang.String domain,
	...
	// many to one
	private com.tnt.core.entity.Ftp uploadFtp;
	private com.tnt.core.entity.CmsConfig config;
	private com.tnt.bbs.entity.BbsCreditExchange creditExchange;
	 ...
	 */
	public com.tnt.core.entity.Ftp getUploadFtp() {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp(com.tnt.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.tnt.core.entity.CmsConfig getConfig() {
		return config;
	}
	 ...
	 *            the config_id value
	 */
	public void setConfig(com.tnt.core.entity.CmsConfig config) {
		this.config = config;
	}

	public com.tnt.bbs.entity.BbsCreditExchange getCreditExchange() {
		return creditExchange;
	}

	public void setCreditExchange(
			com.tnt.bbs.entity.BbsCreditExchange creditExchange) {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.tnt.core.entity.CmsSite))
			return false;
		else {
			com.tnt.core.entity.CmsSite cmsSite = (com.tnt.core.entity.CmsSite) obj;
