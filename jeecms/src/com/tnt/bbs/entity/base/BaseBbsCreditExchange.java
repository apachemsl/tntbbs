...
public abstract class BaseBbsCreditExchange  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tnt.bbs.entity.BbsCreditExchange)) return false;
		else {
			com.tnt.bbs.entity.BbsCreditExchange bbsCreditExchange = (com.tnt.bbs.entity.BbsCreditExchange) obj;
