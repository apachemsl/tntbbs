...
public abstract class BaseBbsMagicLog  implements Serializable {
	...
	// many to one
	private com.tnt.bbs.entity.BbsUser targetUser;
	private com.tnt.bbs.entity.BbsCommonMagic magic;
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getTargetUser () {
		return targetUser;
	}
	 ...
	 */
	public void setTargetUser (com.tnt.bbs.entity.BbsUser targetUser) {
	 ...
	 */
	public com.tnt.bbs.entity.BbsCommonMagic getMagic () {
		return magic;
	}
	 ...
	 */
	public void setMagic (com.tnt.bbs.entity.BbsCommonMagic magic) {
		this.magic = magic;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tnt.bbs.entity.BbsMagicLog)) return false;
		else {
			com.tnt.bbs.entity.BbsMagicLog bbsMagicLog = (com.tnt.bbs.entity.BbsMagicLog) obj;
