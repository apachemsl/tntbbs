...
public abstract class BaseBbsCommonMagic  implements Serializable {
	...
	// collections
	private java.util.Set<com.tnt.bbs.entity.BbsUser> users;
	private java.util.Set<com.tnt.bbs.entity.BbsUserGroup> useGroups;
	private java.util.Set<com.tnt.bbs.entity.BbsUserGroup> toUseGroups;
	 ...
	 */
	public java.util.Set<com.tnt.bbs.entity.BbsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.tnt.bbs.entity.BbsUser> users) {
		this.users = users;
	}
	 ...
	 */
	public java.util.Set<com.tnt.bbs.entity.BbsUserGroup> getUseGroups () {
		return useGroups;
	}
	 ...
	 */
	public void setUseGroups (java.util.Set<com.tnt.bbs.entity.BbsUserGroup> useGroups) {
		this.useGroups = useGroups;
	}
	
	public java.util.Set<com.tnt.bbs.entity.BbsUserGroup> getToUseGroups() {
		return toUseGroups;
	}

	public void setToUseGroups(
			java.util.Set<com.tnt.bbs.entity.BbsUserGroup> toUseGroups) {
		this.toUseGroups = toUseGroups;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.tnt.bbs.entity.BbsCommonMagic)) return false;
		else {
			com.tnt.bbs.entity.BbsCommonMagic bbsCommonMagic = (com.tnt.bbs.entity.BbsCommonMagic) obj;
