...
public abstract class BaseBbsReportExt  implements Serializable {
	...
	// many to one
	private com.tnt.bbs.entity.BbsUser reportUser;
	private com.tnt.bbs.entity.BbsReport report;
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getReportUser () {
		return reportUser;
	}
	 ...
	 */
	public void setReportUser (com.tnt.bbs.entity.BbsUser reportUser) {
	 ...
	 */
	public com.tnt.bbs.entity.BbsReport getReport () {
		return report;
	}
	 ...
	 */
	public void setReport (com.tnt.bbs.entity.BbsReport report) {
		this.report = report;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tnt.bbs.entity.BbsReportExt)) return false;
		else {
			com.tnt.bbs.entity.BbsReportExt bbsReportExt = (com.tnt.bbs.entity.BbsReportExt) obj;
