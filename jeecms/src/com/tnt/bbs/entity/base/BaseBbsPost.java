...
public abstract class BaseBbsPost  implements Serializable {
	...
	public BaseBbsPost (
		...
		com.tnt.bbs.entity.BbsConfig config,
		com.tnt.bbs.entity.BbsTopic topic,
		com.tnt.bbs.entity.BbsUser creater,
	...
	// one to one
	private com.tnt.bbs.entity.BbsPostText postText;

	// many to one
	private com.tnt.core.entity.CmsSite site;
	private com.tnt.bbs.entity.BbsConfig config;
	private com.tnt.bbs.entity.BbsTopic topic;
	private com.tnt.bbs.entity.BbsUser creater;
	private com.tnt.bbs.entity.BbsUser editer;
	private com.tnt.bbs.entity.BbsPostType postType;

	// collections
	private java.util.Set<com.tnt.bbs.entity.BbsGrade> grade;
	private java.util.Set<com.tnt.bbs.entity.Attachment> attachments;
	 ...
	 */
	public com.tnt.bbs.entity.BbsPostText getPostText () {
		return postText;
	}
	 ...
	 */
	public void setPostText (com.tnt.bbs.entity.BbsPostText postText) {
	 ...
	 */
	public com.tnt.core.entity.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (com.tnt.core.entity.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public com.tnt.bbs.entity.BbsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.tnt.bbs.entity.BbsConfig config) {
		this.config = config;
	}
	 ...
	 */
	public com.tnt.bbs.entity.BbsTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.tnt.bbs.entity.BbsTopic topic) {
		this.topic = topic;
	}
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getCreater () {
		return creater;
	}
	 ...
	 */
	public void setCreater (com.tnt.bbs.entity.BbsUser creater) {
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getEditer () {
		return editer;
	}
	 ...
	 */
	public void setEditer (com.tnt.bbs.entity.BbsUser editer) {
		this.editer = editer;
	}

	public com.tnt.bbs.entity.BbsPostType getPostType() {
		return postType;
	}

	public void setPostType(com.tnt.bbs.entity.BbsPostType postType) {
	 ...
	 */
	public java.util.Set<com.tnt.bbs.entity.BbsGrade> getGrade () {
		return grade;
	}
	 ...
	 */
	public void setGrade (java.util.Set<com.tnt.bbs.entity.BbsGrade> grade) {
		this.grade = grade;
	}
	 ...
	 */
	public java.util.Set<com.tnt.bbs.entity.Attachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.Set<com.tnt.bbs.entity.Attachment> attachments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tnt.bbs.entity.BbsPost)) return false;
		else {
			com.tnt.bbs.entity.BbsPost bbsPost = (com.tnt.bbs.entity.BbsPost) obj;
