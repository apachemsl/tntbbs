...
public abstract class BaseBbsMessage  implements Serializable {
	...
	// many to one
	private com.tnt.bbs.entity.BbsUser user;
	private com.tnt.bbs.entity.BbsUser sender;
	private com.tnt.bbs.entity.BbsUser receiver;

	// collections
	private java.util.Set<com.tnt.bbs.entity.BbsMessageReply> reply;
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.tnt.bbs.entity.BbsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getSender () {
		return sender;
	}
	 ...
	 */
	public void setSender (com.tnt.bbs.entity.BbsUser sender) {
		this.sender = sender;
	}
	 ...
	 */
	public com.tnt.bbs.entity.BbsUser getReceiver () {
		return receiver;
	}
	 ...
	 */
	public void setReceiver (com.tnt.bbs.entity.BbsUser receiver) {
	 ...
	 */
	public java.util.Set<com.tnt.bbs.entity.BbsMessageReply> getReply () {
		return reply;
	}
	 ...
	 */
	public void setReply (java.util.Set<com.tnt.bbs.entity.BbsMessageReply> reply) {
		this.reply = reply;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.tnt.bbs.entity.BbsMessage)) return false;
		else {
			com.tnt.bbs.entity.BbsMessage bbsMessage = (com.tnt.bbs.entity.BbsMessage) obj;
