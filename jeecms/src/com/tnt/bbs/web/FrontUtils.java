package com.tnt.bbs.web;

import static com.tnt.bbs.Constants.RES_PATH;
import static com.tnt.bbs.Constants.TPLDIR_COMMON;
import static com.tnt.bbs.Constants.TPLDIR_STYLE_LIST;
import static com.tnt.bbs.Constants.TPLDIR_TAG;
import static com.tnt.bbs.Constants.TPL_STYLE_PAGE_CHANNEL;
import static com.tnt.bbs.Constants.TPL_STYLE_PAGE_TOPIC;
import static com.tnt.bbs.Constants.TPL_SUFFIX;
import static com.tnt.common.web.Constants.MESSAGE;
import static com.tnt.common.web.Constants.UTF8;
import static com.tnt.common.web.ProcessTimeFilter.START_TIME;
import static com.tnt.common.web.freemarker.DirectiveUtils.PARAM_TPL_SUB;
import static com.tnt.core.action.front.LoginAct.PROCESS_URL;
...
import com.tnt.core.web.front.URLHelper;
import com.tnt.core.web.front.URLHelper.PageInfo;
...
public class FrontUtils {
     ...
     * @return
     */
    public static String getTplPath(HttpServletRequest request, CmsSite site, String dir,
                                    String name) {
    ...
    public static String getTplPath(MessageSource messageSource, String lang, String solution,
        ...
        return solution + "/" + dir + "/" + messageSource.getMessage(name, null, locale)
               + TPL_SUFFIX;
    }
    ...
    public static String pageNotFound(HttpServletRequest request, HttpServletResponse response,
        ...
        return getTplPath(request, site, TPLDIR_COMMON, PAGE_NOT_FOUND);
    }
    ...
    public static String showError(HttpServletRequest request, HttpServletResponse response,
                                   Map<String, Object> model, WebErrors errors) {
        CmsSite site = CmsUtils.getSite(request);
        frontData(request, model, site);
    ...
    /**
     * 配置前端freemark模板的路径地址，更具js_cite中的配置拼接路径
     * 
     * @param map
     * @param site
     * @param user
     ...
     * @param mobile
     */
    public static void frontData(Map<String, Object> map, CmsSite site, BbsUser user,
                                 String location, String base, Long startTime, boolean mobile) {
        if (startTime != null) {
     ...
     * @throws TemplateModelException
     */
    public static BbsUser getUser(Environment env) throws TemplateModelException {
        TemplateModel model = env.getGlobalVariable(USER);
        if (model instanceof AdapterTemplateModel) {
            return (BbsUser) ((AdapterTemplateModel) model).getAdaptedObject(CmsSite.class);
        } else {
            throw new TemplateModelException("'" + USER + "' not found in DataModel");
        }
    }
    ...
    public static void includePagination(CmsSite site, Map<String, TemplateModel> params,
     ...
     * @throws TemplateException
     */
    public static void includeTpl(String tplName, CmsSite site, Map<String, TemplateModel> params,
    ...
    public static String replaceSensitivity(String s) {
        ...
        sb.append(StringUtils.replaceEach(s, searchArr, replacementArr));
        return sb.toString();
    }
}
