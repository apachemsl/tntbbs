...
import com.tnt.bbs.dao.BbsUserGroupDao;
...
public class BbsUserGroupMngImpl implements BbsUserGroupMng {
    ...
    @Override
    public void saveOrUpdateGroups(Integer siteId, short groupType, String[] name,
                                   String[] imgPath, Integer[] id, Long[] point) {
    ...
    @Autowired
    public void setDao(BbsUserGroupDao bbsUserGroupDao) {
        this.dao = bbsUserGroupDao;
    }
